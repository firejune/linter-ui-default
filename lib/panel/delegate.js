...
import { getActiveTextEditor, filterMessages, filterMessagesByProject, filterMessagesByRangeOrPoint } from '../helpers'
...
class PanelDelegate {
  ...
  getFilteredMessages(): Array<LinterMessage> {
    ...
    if (this.panelRepresents === 'Entire Project') {
      filteredMessages = filterMessagesByProject(this.messages, activeEditor.getPath())
