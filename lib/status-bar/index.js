...
import { getActiveTextEditor, getRootPathOfMessage } from '../helpers'
...
class StatusBar {
  ...
  update(messages: ?Array<LinterMessage> = null): void {
    ...
    messages.forEach(message => {
      if (
        this.statusBarRepresents === 'Entire Project' ||
        (currentPath && currentPath.startsWith(getRootPathOfMessage(message)))
      ) {
